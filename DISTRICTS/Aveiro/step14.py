...
import os
os.chdir(r"C:\Users\andre\Desktop\scripts\DISTRITOS\Aveiro")

# Leitura do CSV com parse das datas
df = pd.read_csv (r'aveiro.csv', sep=';', thousands=',', parse_dates=['DATA'], dayfirst=True) #, header=None, names=headers, dtype=dtypes
#print (df)
