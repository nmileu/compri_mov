...
import numpy as np
import os
os.chdir(r"C:\Users\andre\Desktop\scripts\DISTRITOS\Braga")

# Leitura do CSV com parse das datas
df = pd.read_csv (r'braga.csv', sep=';', thousands=',', parse_dates=['DATA'], dayfirst=True) #, header=None, names=headers, dtype=dtypes
#print (df)
