...
import os
os.chdir(r"C:\Users\andre\Desktop\scripts\DISTRITOS\Faro")

# Leitura do CSV com parse das datas
df = pd.read_csv (r'faro.csv', sep=';', thousands=',', parse_dates=['DATA'], dayfirst=True) #, header=None, names=headers, dtype=dtypes
#print (df)
