...
import os
os.chdir(r"C:\Users\andre\Desktop\scripts\DISTRITOS\Leiria")

# Leitura do CSV com parse das datas
df = pd.read_csv (r'leiria.csv', sep=';', thousands=',', parse_dates=['DATA'], dayfirst=True) #, header=None, names=headers, dtype=dtypes
#print (df)
