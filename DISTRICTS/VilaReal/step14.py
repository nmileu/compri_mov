...
import os
os.chdir(r"C:\Users\andre\Desktop\scripts\DISTRITOS\VilaReal")

# Leitura do CSV com parse das datas
df = pd.read_csv (r'vilareal.csv', sep=';', thousands=',', parse_dates=['DATA'], dayfirst=True) #, header=None, names=headers, dtype=dtypes
#print (df)
